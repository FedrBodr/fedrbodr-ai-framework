...
Это независимая от провайдера ИИ инженерная методология. Она объединяет долговечные знания проекта, процесс соразмерный риску, переносимые инженерные навыки, человеческое управление, свидетельства проверки и заменяемые AI-инструменты.
...
Содержательная реализация не начинается до появления достаточной спецификации и необходимого человеческого ревью. Для небольшого изменения с низким риском спецификацию и review можно объединить в короткой design note. Соразмерность уменьшает церемонию, но не исключает рассуждение.
